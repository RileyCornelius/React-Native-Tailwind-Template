...
const AlertDialog = React.forwardRef<React.ComponentRef<typeof UIAccessibleAlertDialog>, IAlertDialogProps>(function AlertDialog(
	...
	return (
		<UIAccessibleAlertDialog ref={ref} {...props} className={alertDialogStyle({ class: className })} context={{ size }} pointerEvents="box-none" />
	);
});
...
const AlertDialogCloseButton = React.forwardRef<React.ComponentRef<typeof UIAccessibleAlertDialog.CloseButton>, IAlertDialogCloseButtonProps>(
...
const AlertDialogBody = React.forwardRef<React.ComponentRef<typeof UIAccessibleAlertDialog.Body>, IAlertDialogBodyProps>(function AlertDialogBody(
	{ className, ...props },
	ref
) {
	return (
