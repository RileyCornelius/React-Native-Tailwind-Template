		...
		<Box className="flex-1 bg-background-0">
			<KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} className="flex-1">
				<ScrollView className="flex-1" contentContainerStyle={{ flexGrow: 1 }}>
					<VStack className="flex-1 p-4 max-w-[600px] w-full self-center" space="xl">
						<VStack space="xs">
						...
						<VStack space="lg" className="flex-1">
							...
							<HStack space="md" className="mt-4 w-full">
								<Button className="flex-1 rounded-xl" variant="solid" action="primary">
									<ButtonText>Submit</ButtonText>
								</Button>
								<Button className="flex-1 rounded-xl" variant="outline" action="secondary">
